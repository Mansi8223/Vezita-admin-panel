...
function ViewDoctorsDispute() {
    ...
    return (
        <>
            ...
            <Base>
                <Header title={"Doctor's Disputes"}></Header>
                ...
                <DoctorDisputes data={data} searchTerm={searchTerm}/>
            </Base>
            </Fragment>}
        </>
      )
...
export default ViewDoctorsDispute