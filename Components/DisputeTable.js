...
function DisputeTable({data,searchTerm}) {
            ...
            if(searchTerm == ""){
              ...
              return val
                ...
                <TableRow key={index+1} className={`table-body`}>
                  <TableCell component="th" scope="row">{item.user.fullName}</TableCell>
                  <TableCell align="left">{item.noOfDisuputes}</TableCell>
                  <TableCell align="center">
                    <Link href={`/ViewDoctorsDispute/${item.user.user}`}>
