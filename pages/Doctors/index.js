...
function Doctors() {
  ...
  const[loading, setLoading]=useState(false)
    useEffect(()=>{
      ...
      fetch("https://vezita-backend.herokuapp.com/api/v1/docter/all/for-admin", requestOptions)
          ...
          <Base>
              ...
              <div className={`col-10 col-md-12 col-xl-9 buttons d-flex d-justify-end gap-2 pr-1 mt-5`}>
                <div className='border-none bg-blue d-flex d-align-center pt-3 pb-3 pl-5 pr-5 rounded-100'>
                    ...
                    <Link href='/AddDoctor'><h5 className='ml-2 f-500 l-22 text-white'>Add Doctors</h5></Link>
                </div>
              </div>
              ...
              <DoctorsTable data={data} searchTerm={searchTerm}/>
          </Base>
      </Fragment>}
      </>
    )
