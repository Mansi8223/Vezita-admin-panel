...
import styles from '../styles/css/ChatScreen.module.css'
function ChatScreen() {
  return (
        <div className={`${styles["wrapper"]} col-7 d-flex d-flex-column rounded-16 p-5 bg-white`}>
            <div className={`col-11 d-flex d-flex-row d-align-center gap-5`}>
                <Avatar/>
