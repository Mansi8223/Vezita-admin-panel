...
function PatientsTable({data,searchTerm}) {
    return (
          ...
          <Table size="small" aria-label="a dense table" >
            <TableHead className={`bg-secondary`}>
              <TableRow className={`table-header`}>
                ...
                <TableCell align="left">No. of consultations</TableCell>
                <TableCell align="left">Last Dr. consulted</TableCell>
            ...
            if(searchTerm == ""){
              ...
              return val
                ...
                <TableRow key={index+1} className={`table-body`}>
                  ...
                  <TableCell align="left">{item.consultationFor}</TableCell>
                  <TableCell align="left">{item.noOfConsultation}</TableCell>
                  <TableCell align="left">{item.docter.fullName}</TableCell>
                  <TableCell align="center">
                    <Link href={`/Patients/${item._id}`}>
